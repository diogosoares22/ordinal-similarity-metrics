...
class BatchedTSI:
    """
    The BatchedTSI class is used to efficiently compute the approximate TSI between two representations but without mathematical guarantees.
    """
