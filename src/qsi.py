...
class BatchedQSI:
    """
    The BatchedQSI class is used to efficiently compute the approximate QSI between two representations but without mathematical guarantees.
    """
    def __init__(self, euclidean: bool = False, n_threads: int = 8, batch_size: int = 100, no_batches: int = 10, seed: int = 42):
        self.name = "BatchedQSI"
        self.n_threads = n_threads
